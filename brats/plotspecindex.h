/* Plot the spectral index map of a given data set
   ...
   Basic usage. We assume imgnum is already set...

   float **alpha;
   alpha = calloc(imgnum, sizeof(float *));

   ...
   specindex(flux, alpha, numregions, map1, map2, freq1, freq2, 1);
...
#include "smoothmaps.h"
  ...
  printf("Creating a spectral index map...\n");
  ...
  float crop = 1.0; // For the later implimentation of non-square maps
  ...
  if ( (exportfits !=1) || (export != 1) ) { // Do the standard plotting
    ...
    zoomedx =  xdim[currentset] / (zoom*crop);
    ...
    if (smoothmaps == 1) {
	  ...
	  if ( ((i+jstart-border) < 0) || ((j+istart-border) < 0) || ((i+jstart-border) >= xaxismax) || ((j+istart-border) >= yaxismax) ) {
	    ...
	    tmp_smootharray[i*jsize+j] = specindex[currentset][regionarray[currentset][i+(jstart-border)][j+(istart-border)]];
	...
	adj_maxrange = 0.1;
      ...
      cpgwedg("RI", 1.5, 5.0, minrange, adj_maxrange, "Spectral Index");
	...
	for (j=border; j<(ydim[currentset]-border); j++){
	  ...
	  else if (specindex[currentset][regionarray[currentset][i][j]] > 1e33) {
	    intenscale = 0;
	  }

	  else {

	    if (specindex[currentset][regionarray[currentset][i][j]] >= (maxsi[currentset] - ((maxsi[currentset]-minsi[currentset])/15)) ) {
	      intenscale = 1;
	    }
	    else if ( (specindex[currentset][regionarray[currentset][i][j]] < (maxsi[currentset] - ((maxsi[currentset]-minsi[currentset])/15))) && (specindex[currentset][regionarray[currentset][i][j]] >= (maxsi[currentset] - (2*((maxsi[currentset]-minsi[currentset])/15)))) ) {
	      intenscale = 2;
	    }
	    else if ( (specindex[currentset][regionarray[currentset][i][j]] < (maxsi[currentset] - (2*((maxsi[currentset]-minsi[currentset])/15)))) && (specindex[currentset][regionarray[currentset][i][j]] >= (maxsi[currentset] - (3*((maxsi[currentset]-minsi[currentset])/15)))) ) {
	      intenscale = 3;
	    }
	    else if ( (specindex[currentset][regionarray[currentset][i][j]] < (maxsi[currentset] - (3*((maxsi[currentset]-minsi[currentset])/15)))) && (specindex[currentset][regionarray[currentset][i][j]] >= (maxsi[currentset] - (4*((maxsi[currentset]-minsi[currentset])/15)))) ) {
	      intenscale = 4;
	    }
	    else if ( (specindex[currentset][regionarray[currentset][i][j]] < (maxsi[currentset] - (4*((maxsi[currentset]-minsi[currentset])/15)))) && (specindex[currentset][regionarray[currentset][i][j]] >= (maxsi[currentset] - (5*((maxsi[currentset]-minsi[currentset])/15)))) ) {
	      intenscale = 5;
	    }
	    else if ( (specindex[currentset][regionarray[currentset][i][j]] < (maxsi[currentset] - (5*((maxsi[currentset]-minsi[currentset])/15)))) && (specindex[currentset][regionarray[currentset][i][j]] >= (maxsi[currentset] - (6*((maxsi[currentset]-minsi[currentset])/15)))) ) {
	      intenscale = 6;
	    }
	    else if ( (specindex[currentset][regionarray[currentset][i][j]] < (maxsi[currentset] - (6*((maxsi[currentset]-minsi[currentset])/15)))) && (specindex[currentset][regionarray[currentset][i][j]] >= (maxsi[currentset] - (7*((maxsi[currentset]-minsi[currentset])/15)))) ) {
	      intenscale = 7;
	    }
	    else if ( (specindex[currentset][regionarray[currentset][i][j]] < (maxsi[currentset] - (7*((maxsi[currentset]-minsi[currentset])/15)))) && (specindex[currentset][regionarray[currentset][i][j]] >= (maxsi[currentset] - (8*((maxsi[currentset]-minsi[currentset])/15)))) ) {
	      intenscale = 8;
	    }
	  
	    else if ( (specindex[currentset][regionarray[currentset][i][j]] < (maxsi[currentset] - (8*((maxsi[currentset]-minsi[currentset])/15)))) && (specindex[currentset][regionarray[currentset][i][j]] >= (maxsi[currentset] - (9*((maxsi[currentset]-minsi[currentset])/15)))) ) {
	      intenscale = 9;
	    }
	    else if ( (specindex[currentset][regionarray[currentset][i][j]] < (maxsi[currentset] - (9*((maxsi[currentset]-minsi[currentset])/15)))) && (specindex[currentset][regionarray[currentset][i][j]] >= (maxsi[currentset] - (10*((maxsi[currentset]-minsi[currentset])/15)))) ) {
	      intenscale = 10;
	    }
	    else if ( (specindex[currentset][regionarray[currentset][i][j]] < (maxsi[currentset] - (10*((maxsi[currentset]-minsi[currentset])/15)))) && (specindex[currentset][regionarray[currentset][i][j]] >= (maxsi[currentset] - (11*((maxsi[currentset]-minsi[currentset])/15)))) ) {
	      intenscale = 11;
	    }

	    else if ( (specindex[currentset][regionarray[currentset][i][j]] < (maxsi[currentset] - (11*((maxsi[currentset]-minsi[currentset])/15)))) && (specindex[currentset][regionarray[currentset][i][j]] >= (maxsi[currentset] - (12*((maxsi[currentset]-minsi[currentset])/15)))) ) {
	      intenscale = 12;
	    }
	  
	    else if ( (specindex[currentset][regionarray[currentset][i][j]] < (maxsi[currentset] - (12*((maxsi[currentset]-minsi[currentset])/15)))) && (specindex[currentset][regionarray[currentset][i][j]] >= (maxsi[currentset] - (13*((maxsi[currentset]-minsi[currentset])/15)))) ) {
	      intenscale = 13;
	    }
	    else if ( (specindex[currentset][regionarray[currentset][i][j]] < (maxsi[currentset] - (13*((maxsi[currentset]-minsi[currentset])/15)))) && (specindex[currentset][regionarray[currentset][i][j]] >= (maxsi[currentset] - (14*((maxsi[currentset]-minsi[currentset])/15)))) ) {
	      intenscale = 14;
	    }	 


	    else if ( (specindex[currentset][regionarray[currentset][i][j]] < (maxsi[currentset] - (14*((maxsi[currentset]-minsi[currentset])/15)))) && (specindex[currentset][regionarray[currentset][i][j]] >= minsi[currentset]) ) {
	      intenscale = 15;
	    }
	...
	for (j=0; j<yaxismax; j++) {
	  ...
	  if (regionarray[currentset][i][j] < 0) { // Set void regions to a high value to create a white background
	    ...
	    tmp_smootharray[i*xaxismax+j] = specindex[currentset][regionarray[currentset][i][j]];
	...
	return 404;
      ...
      FunParamPuts(funconn, "HISTORY", 0, historytext, NULL, 1);
      strcpy(historytext, "BRATS  Spectral index  map between ");
